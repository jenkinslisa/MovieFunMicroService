...
public class MoviesClient {
    ...
    private static ParameterizedTypeReference<List<MoviesInfo>> movieListType = new ParameterizedTypeReference<List<MoviesInfo>>() {
    };
    ...
    public void addMovie(MoviesInfo movie) {
        restOperations.postForEntity(moviesUrl, movie, MoviesInfo.class);
    }
    ...
    public List<MoviesInfo> findAll(int start, int pageSize) {
    ...
    public List<MoviesInfo> findRange(String field, String key, int start, int pageSize) {
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(moviesUrl)
                .queryParam("field", field)
                .queryParam("key", key)
                .queryParam("start", start)
    ...
    public List<MoviesInfo> getMovies() {
